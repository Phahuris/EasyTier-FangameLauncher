...
pub fn run_gui() -> std::process::ExitCode {
    ...
    let app = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            chat::chat_bootstrap,
            chat::chat_set_network_name,
            chat::chat_set_local_ip,
            ...
            fangame_detect::verify_fgl_plugins,
            fangame_detect::write_game_command,
            fangame_detect::verify_fgl_plugins,
            fangame_detect::is_fangame_allowed_lang,
            fangame_detect::verify_fgl_plugins,
            fangame_detect::install_fgl_plugins,
            fangame_detect::verify_fgl_plugins,
            fangame_detect::is_fangame_allowed_lang,
            fangame_detect::verify_fgl_plugins,
            fangame_detect::is_fangame_allowed,
            fangame_detect::verify_fgl_plugins,
            fangame_detect::is_fangame_allowed_lang,
            fangame_detect::verify_fgl_plugins,
            fangame_detect::cleanup_fgl_temp,
            fangame_detect::verify_fgl_plugins,
            fangame_detect::is_fangame_allowed_lang,
            fangame_detect::verify_fgl_plugins,
            fangame_detect::prepare_and_patch_fangame,
            fangame_detect::verify_fgl_plugins,
            fangame_detect::is_fangame_allowed_lang,
            fangame_detect::verify_fgl_plugins,
            fangame_detect::write_game_command,
            ...
            fangame_detect::is_fangame_allowed_lang,
            fangame_detect::verify_fgl_plugins,
            fangame_detect::check_fgl_plugin,
            fangame_detect::verify_fgl_plugins,
            fangame_detect::is_fangame_allowed_lang,
            fangame_detect::verify_fgl_plugins,
            fangame_detect::write_game_command,
            ...
            fangame_detect::is_fangame_allowed_lang,
            fangame_detect::verify_fgl_plugins,
            fangame_detect::inject_fgl_test_script,
            fangame_detect::verify_fgl_plugins,
            fangame_detect::is_fangame_allowed_lang,
            fangame_detect::verify_fgl_plugins,
            fangame_detect::write_game_command,
            ...
            fangame_detect::is_fangame_allowed_lang,
            fangame_detect::verify_fgl_plugins,
            fangame_detect::list_rxdata_scripts,
            fangame_detect::verify_fgl_plugins,
            fangame_detect::is_fangame_allowed_lang,
            fangame_detect::verify_fgl_plugins,
            fangame_detect::write_game_command,
